    ...
    <div className="App">
      ...
      <div className="about-us-container">
        <div className="about-us-content">
          ...
          <p>Tutor virtual ofrece una experiencia versátil tanto para profesores como para estudiantes.</p>
          <p>Si eres profesor, puedes utilizar nuestra plataforma para crear cursos, proporcionando a tus alumnos una experiencia de aprendizaje enriquecedora. Si eres estudiante, nuestra aplicación te permite acceder a una amplia gama de cursos y hacer preguntas relacionadas con el contenido de estos.</p>
        </div>
